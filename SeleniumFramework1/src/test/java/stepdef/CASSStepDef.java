...
public class CASSStepDef {
    ...
    public void verifyAddressPopupForBillingProviderInDataCapture(){
        ...
        for (int i=0; i<excelData.size(); i++) {
            ...
            dataCapturePage.pressTabKey(15);
            dataCapturePage.clickSameAsServiceProviderCheckBox();
            dataCapturePage.verifyAddressPopup();
            System.out.println("Successfully verified the CASS address popup for "+excelData.get(i).get("Env_Name"));
            System.out.println("=================================================================");
            dataCapturePage.deleteAllCookies();
        }
    }
}
