...
public class ConfigManager {
    ...
    private void loadProperties() {
        ...
        try {
            ...
            System.out.println("Cannot find configuration file at " + configFilePath);
            Assert.fail("Cannot find configuration file at " + configFilePath);
        } catch (IOException e) {
            System.out.println("Cannot read configuration file at " +configFilePath);
    ...
    public void setCellValue(String sheetName, String existingDoc, String cellValue, String dbName) throws IOException {
        ...
        cell.setCellValue(new SimpleDateFormat("yyyy-MM-dd-HH:mm").format(new java.util.Date()));
        fis.close();
    ...
    public static String getExcelPath() {
        ...
        if (System.getProperty("excelPath") != null) {
            ...
            path = System.getProperty("user.dir") + "/src/test/java/testdata/HealthChecks.xls";
        }
